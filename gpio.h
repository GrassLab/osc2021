...
#define GPIO_BASE       (MMIO_BASE + 0x00200000)  // Rpi3 use 16MB memory for MMIO, BROADCOM User Manual page 5.


// BROADCOM User Manual page 91.
#define GPFSEL0         ((volatile unsigned int*)(GPIO_BASE + 0x00)) // GPIO Function Select Registers
