...
// for lab8 req2
#define USER_STACK_BASE 		((unsigned long)0x1000000000000 - THREAD_SIZE)
#define USER_PROGRAM_BASE 		0x80000
#define USER_PROGRAM_SIZE 		(16 * (unsigned long)1024)
...
struct thread 
{
	...
	unsigned long *pgd;
	unsigned int page_frame_ids[MAX_PAGE_FRAME_PER_THREAD];
	unsigned int page_frame_count;
};
